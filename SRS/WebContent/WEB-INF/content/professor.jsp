...
<script>
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:
            [{text:'系统管理',items:[{id:'12',text:'选课情况',href:'courseNow.action?ssn=${person.ssn}&name=${person.name }'},
                                 {id:'3',text:'课程操作',href:'courseNow.action?ssn=${person.ssn}&name=${person.name }'}]
            }]}];
