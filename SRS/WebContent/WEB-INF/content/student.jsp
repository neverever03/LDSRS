...
<script>
    ...
    BUI.use('common/main',function(){
        var config = [{id:'1',menu:
            [{text:'系统管理',items:[{id:'12',text:'学习计划',href:'planOfStudy.action?ssn=${person.ssn}&name=${person.name }'},
                                 {id:'3',text:'选课系统',href:'section?ssn=${person.ssn}'},
                                 {id:'4',text:'查看成绩',href:'hasCourse?ssn=${person.ssn}'},
